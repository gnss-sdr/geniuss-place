...
| `otw_format` | [`sc16` (Q16 I16), `sc8` (Q8_1 I8_1 Q8_0 I8_0), `sc12` (only some devices)]: Set the over-the-wire format (that is, the sample format used between the UHD and the host device). It defaults to `sc16`. <span style="color:orange">NOTE: this feature is only present on the `next` branch and it will be included in the next stable release.</span> | Optional |
