...
## KML, GeoJSON, GPX
For Geographic Information Systems, map representation and Earth browsers: [KML](http://www.opengeospatial.org/standards/kml),  [GeoJSON](https://geojson.org/) and [GPX](http://www.topografix.com/gpx.asp) files are generated by default, upon the computation of the first position fix.
