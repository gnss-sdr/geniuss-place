...
|           `use_e6_for_pvt`           | [`true`, `false`]: If set to `false`, the PVT engine will ignore observables from Galileo E6B signals. It defaults to `true`, so observables will be used if found. <span style="color: orange">NOTE: this parameter is only present on the `next` branch of the upstream repository and it will be included in the next stable release.</span>                                                                                                                                                                                                                                                                                                                                                                                |   Optional   |
|        `use_has_corrections`         | [`true`, `false`]: If set to `false`, the PVT engine will ignore corrections from the Galileo High Accuracy Service. It defaults to `true`, so corrections will be applied if available. <span style="color: orange">NOTE: this parameter is only present on the `next` branch of the upstream repository and it will be included in the next stable release.</span>                                                                                                                                                                                                                                                                                                                                                           |   Optional   |
|         `use_unhealthy_sats`         | [`true`, `false`]: If set to `true`, the PVT engine will use observables from satellites flagged as unhealthy in the navigation message. It defaults to `false`, so those observables will be ignored. <span style="color: orange">NOTE: this parameter is only present on the `next` branch of the upstream repository and it will be included in the next stable release.</span>                                                                                                                                                                                                                                                                                                                                             |   Optional   |
...
|           `bancroft_init`            | [`true`, `false`]: If set to `false`, the [Bancroft initialization](https://gssc.esa.int/navipedia/index.php/Bancroft_Method) in the first iteration of the PVT computation is skipped. It defaults to `true`. <span style="color: orange">NOTE: this parameter is only present on the `next` branch of the upstream repository and it will be included in the next stable release.</span>                                                                                                                                                                                                                                                                                                                                     |   Optional   |
|              ----------              |
