...
toc: true
toc_sticky: true
last_modified_at: 2018-06-05T15:54:02-04:00
---
...
This _PVT_ implementation computes position fixes using GPS L1 C/A signals and a basic, memoryless Least Squares solution. Those solutions are exported to KML and GeoJSON formats for their graphical representation.
...
| `flag_averaging` |  Performs averaging over the internally generated results before outputting them. It defaults to `false`. | Optional |
...
This _PVT_ implementation computes position fixes using Galileo E1B signals and a basic, memoryless Least Squares solution. Those solutions are exported to KML and GeoJSON formats for their graphical representation.
