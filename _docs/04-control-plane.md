...
header:
  teaser: multi-band-multi-system-flow-graph.png
...
![Basic GNSS flow graph]({{ site.url }}{{ site.baseurl }}/images/simple-gnss-sdr-flowgraph.png){:width="600x"}{: .align-center}
...
![Complex GNSS flow graph]({{ site.url }}{{ site.baseurl }}/images/multi-band-multi-system-flow-graph.png){: .align-center}
