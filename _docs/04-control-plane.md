...
<a name="generic_flowgraph">![Complex GNSS flow graph]({{ "/assets/images/multi-band-multi-system-flow-graph.png" | relative_url }}){: .align-center .invert-colors}
...
[Next section]({{ "/docs/sp-blocks/" | relative_url }}) describes the available implementations for each of the available GNSS-SDR processing blocks and how they are configured.
