...
<span class="invert-colors">![Basic GNSS flow graph]({{ "/assets/images/simple-gnss-sdr-flowgraph.png" | relative_url }}){:width="600x"}</span>{: .align-center}
...
<span class="invert-colors">![Complex GNSS flow graph]({{ "/assets/images/multi-band-multi-system-flow-graph.png" | relative_url }})</span>{: .align-center}
