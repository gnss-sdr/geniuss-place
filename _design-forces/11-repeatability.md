...
![Accuracy vs Precision]({{ site.url }}{{ site.baseurl }}/assets/images/accuracy-and-precision.png){:width="520x"}
...
![2D scatter plot]({{ site.url }}{{ site.baseurl }}/assets/images/2d-accuracy.png){:width="600x"}
{: style="text-align: center;"}
