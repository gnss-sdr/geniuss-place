...
from a file). Please check the documentation about the GNSS-SDR
[OSNMA-related configuration parameters]({{ "/docs/sp-blocks/global-parameters/#open-service-navigation-message-authentication-osnma" | relative_url }}).
