...
toc_sticky: true
show_date: false
last_modified_at: 2022-02-09T09:17:02+02:00
---
...
|:--|:-:|:-:|:--|
|--------------
| `-DENABLE_GENERIC_ARCH` | `ON` / `OFF` | `OFF` | If set to `ON`, it builds portable binaries that are non-dependent on the SIMD technologies present in the building machine. |
