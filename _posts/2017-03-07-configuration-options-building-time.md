...
| <span style="color: DarkOrange">&#x2011;DPYTHON_EXECUTABLE</span>  | <span style="color: DarkOrange">System path</span>  | <span style="color: DarkOrange">System-dependent.</span> |<span style="color: DarkOrange">Path to the Python interpreter. By default, GNSS-SDR searches for Python 2.7 and, if not found, it searches for Python 3 at standard locations in your system. You can specify the path of the Python interpreter by setting this variable (*e.g.*  ```/path/to/python3```).</span> |
|----------
