...
toc_sticky: true
show_date: false
last_modified_at: 2021-06-05T12:54:02+02:00
---
...
settings](https://docs.github.com/en/account-and-profile/setting-up-and-managing-your-github-user-account/managing-email-preferences/adding-an-email-address-to-your-github-account).
...
if you are planning to make changes and to submit a Pull Request. {% endcapture %}
...
(formerly known as `master`) and `next`:
