...
or by browsing to [https://github.com/gnss-sdr/gnss-sdr](https://github.com/gnss-sdr/gnss-sdr){:target="_blank"} and clicking in the Fork button at the upper-right corner of the screen: ![Fork button]({{ site.url }}{{ site.baseurl }}/assets/images/fork_button.jpg)
...
![Git repository]({{ site.url }}{{ site.baseurl }}/assets/images/git-repository.jpg)
{: style="text-align: center;"}
