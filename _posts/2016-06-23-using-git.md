...
out there. If you have never used it, start from the [Git Basics](http://git-scm.com/book/en/v2/Getting-Started-Git-Basics) or this [interactive  learning game that takes just 15 minutes](https://try.github.io/levels/1/challenges/1).
...
or by browsing to [https://github.com/gnss-sdr/gnss-sdr](https://github.com/gnss-sdr/gnss-sdr) and clicking in the Fork button at the upper-right corner of the screen: ![Fork button]({{ "/assets/images/fork_button.jpg" | absolute_url }})

Once you have forked the repository, open a terminal and (if you have not done so yet) [configure Git](https://help.github.com/articles/set-up-git/) with some basic information, such as your identity:
...
-   **Use an integrated development environment (IDE) with Git
    ...
    An open source, well-known option is [Eclipse](http://www.eclipse.org/), and we love using [EGit](http://www.eclipse.org/egit/), an Eclipse Team provider for
    Git.
...
-   **Before creating the patch file, please be sure that after your
    ...
    recommended [coding style]({{ "/coding-style/" | absolute_url }}) (indentation, white spaces, naming conventions and
