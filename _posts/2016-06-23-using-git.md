...
or by browsing to [https://github.com/gnss-sdr/gnss-sdr](https://github.com/gnss-sdr/gnss-sdr) and clicking in the Fork button at the upper-right corner of the screen: ![]({{ site.url }}{{ site.baseurl }}/images/fork_button.jpg)
...
-   **Keep you changes referred to the latest commit of `uspream/next`
...
-   **Before creating the patch file, please be sure that after your
    ...
    recommended [coding style]({{ site.url }}{{ site.baseurl }}/coding-style/) (indentation, white spaces, naming conventions and
